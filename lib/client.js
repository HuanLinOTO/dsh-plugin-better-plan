	...
	factory: (require) => {
		...
		*/
		...
		function isReviewState(value) {
			...
			const record = value;
			return typeof record.id === "string" && record.id !== "" && typeof record.path === "string" && record.path !== "" && typeof record.title === "string" && (record.status === "pending" || record.status === "approved" || record.status === "kept" || record.status === "cancelled");
		}
		...
		async function submitReviewDecision(sessionId, decision, feedback, reviewId) {
			try {
				...
				if (!isReviewState(parsed.review)) return {
					ok: false,
					error: "unexpected review response"
				};
		...
		*/
		...
		function settledReviewText(status) {
		...
		*/
		function PlanView(props) {
			...
			const settledReview = review !== null && review.path === path && review.status !== "pending" ? settledReviewText(review.status) : null;
			...
			return (0, react.createElement)("div", { style: styles.root }, (0, react.createElement)("div", { style: styles.header }, (0, react.createElement)("div", { style: styles.titleRow }, (0, react.createElement)("span", {
				...
				style: styles.button,
				onClick: copyPath
			}, copied ? "Copied" : "Copy path") : null)), path !== void 0 ? (0, react.createElement)("div", { style: styles.path }, path) : null), pendingReview !== null ? (0, react.createElement)("div", { style: styles.reviewBar }, (0, react.createElement)("div", { style: styles.reviewText }, "Review this plan here — the chat shows no approval popup. Approve to leave plan mode, or keep planning with feedback."), (0, react.createElement)("input", {
