 ...
 */
export function isTrustedDeliveryRequest(request: FenceRequest, trustedHosts: readonly string[]): boolean {
  ...
  // hostname. Absent Origin is fine (non-browser client); the literal "null"
  // (sandboxed iframes) is an opaque origin, refused.
